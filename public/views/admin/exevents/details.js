...
(function() {
  ...
  app.Exchange = Backbone.Model.extend({
    idAttribute: '_id',
    url: function() {
      return '/admin/exevents/'+ this.id +'/';
    }
  });
  ...
  app.Delete = Backbone.Model.extend({
    ...
    url: function() {
      return '/admin/exevents/'+ app.mainView.model.id +'/';
    }
  });
  ...
  app.ContentView = Backbone.View.extend({
    ...
    syncUp: function() {
      this.model.set({
        ...
        date0: app.mainView.model.get('date0'),
        date1: app.mainView.model.get('date1'),
  ...
  app.MainView = Backbone.View.extend({
    ...
    initialize: function() {
      app.mainView = this;
      this.model = new app.Exchange( JSON.parse( unescape($('#data-record').html())) );
