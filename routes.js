...
exports = module.exports = function(app, passport) {
	...
	app.get('/event/:id/validation/:id/validate', require('./views/events/validations/validations').validate);
	app.get('/event/:id/validation/:id/refuse', require('./views/events/validations/validations').refuse);
